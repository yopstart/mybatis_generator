...
public class CrmLeadsStudentAllot implements Serializable {
    /**
     * 主键ID
     */
    @Id
     ...
     * 被分配的线索用户ID
     */
    @Column(name = "crm_leads_student_id")
    private Long crmLeadsStudentId;
     ...
     * 获取被分配的线索用户ID
     *
     * @return crm_leads_student_id - 被分配的线索用户ID
     */
    public Long getCrmLeadsStudentId() {
        return crmLeadsStudentId;
    }

    /**
     * 设置被分配的线索用户ID
     *
     * @param crmLeadsStudentId 被分配的线索用户ID
     */
    public void setCrmLeadsStudentId(Long crmLeadsStudentId) {
        this.crmLeadsStudentId = crmLeadsStudentId;
    }
    ...
    public String toString() {
        ...
        sb.append(", crmLeadsStudentId=").append(crmLeadsStudentId);
