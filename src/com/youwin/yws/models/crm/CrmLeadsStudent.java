...
public class CrmLeadsStudent implements Serializable {
    /**
     * 主键ID
     */
    @Id
    ...
    /**
     * 获取线索用户状态 1:已签约 2:未签约
     *
     * @return state - 线索用户状态 1:已签约 2:未签约
     */
    ...
    /**
     * 设置线索用户状态 1:已签约 2:未签约
     *
     * @param state 线索用户状态 1:已签约 2:未签约
     */
