...
public class CrmDataOrganizationDetail implements Serializable {
    /**
     * 主键ID
     */
    @Id
     ...
     * 获取线索用户主表ID
     *
     * @return leads_organization_id - 线索用户主表ID
     */
     ...
     * 设置线索用户主表ID
     *
     * @param leadsOrganizationId 线索用户主表ID
     */
